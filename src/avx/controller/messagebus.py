...
A little modified by James Muscat from its original version at
https://github.com/irmen/Pyro4/blob/master/examples/messagebus
"""
...
__all__ = ["MessageBus", "Message", "PYRO_MSGBUS_NAME", "SerializerBase"]
...
class Message(object):
    ...
    def __repr__(self):
        return str(Message.to_dict(self))
...
class MemoryStorage(object):
    ...
    """
    def __init__(self):
        self.messages = defaultdict(list)      # topic -> list of pending messages
